...
public class _EJSRemoteStatelessSequenceSession_a4d12cbf_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessSequenceSession_a4d12cbf target = null;
    private ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:ru.md.sequence.ejb.SequenceSession:0000000000000000", 
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessSequenceSession_a4d12cbf) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 120: 
                    if (method.equals("getNextNumberInSequence")) {
                        return getNextNumberInSequence(in, reply);
                    }
            }
    ...
    private OutputStream getNextNumberInSequence(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        long result = target.getNextNumberInSequence(arg0);
        OutputStream out = reply.createReply();
