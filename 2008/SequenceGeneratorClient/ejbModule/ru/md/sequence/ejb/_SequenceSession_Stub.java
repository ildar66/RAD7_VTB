...
public class _SequenceSession_Stub extends Stub implements SequenceSession {
    ...
    public long getNextNumberInSequence(String arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            ...
                            _request("getNextNumberInSequence", true);
                ...
                ServantObject so = _servant_preinvoke("getNextNumberInSequence",ru.md.sequence.ejb.SequenceSession.class);
                if (so == null) {
                    continue;
                }
                try {
                    return ((ru.md.sequence.ejb.SequenceSession)so.servant).getNextNumberInSequence(arg0);
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
                } finally {
