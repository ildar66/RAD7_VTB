...
public class _SequenceSessionHome_Stub extends Stub implements SequenceSessionHome {
    
    private static final String[] _type_ids = {
        "RMI:ru.md.sequence.ejb.SequenceSessionHome:0000000000000000", 
    ...
    public SequenceSession create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SequenceSession) in.read_Object(SequenceSession.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",ru.md.sequence.ejb.SequenceSessionHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SequenceSession result = ((ru.md.sequence.ejb.SequenceSessionHome)so.servant).create();
                    return (SequenceSession)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
