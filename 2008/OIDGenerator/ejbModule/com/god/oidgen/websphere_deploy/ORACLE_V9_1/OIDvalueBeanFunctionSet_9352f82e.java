...
public class OIDvalueBeanFunctionSet_9352f82e extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.ID, T1.VALUE FROM SEQUENCES  T1 WHERE T1.ID = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.ID, T1.VALUE FROM SEQUENCES  T1 WHERE T1.ID = ? FOR UPDATE ";
	/**
	...
	public void PartialStore(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		...
		try {
			...
			if (updateTemplateList == null)
				initializeUpdateTemplates();
			{
				com.ibm.ws.ejbdeploy.JOIDGenerator.ORACLE_V9_1.RdbRuntimeUpdateTemplate aTemplate = (com.ibm.ws.ejbdeploy.JOIDGenerator.ORACLE_V9_1.RdbRuntimeUpdateTemplate) updateTemplateList.get(0);
