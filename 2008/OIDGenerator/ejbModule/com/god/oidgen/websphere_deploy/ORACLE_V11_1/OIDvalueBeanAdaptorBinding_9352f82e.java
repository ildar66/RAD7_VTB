...
/**
 * OIDvalueBeanAdaptorBinding_9352f82e
 */
public class OIDvalueBeanAdaptorBinding_9352f82e implements com.ibm.ws.ejbpersistence.beanextensions.EJBAdapterBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.god.oidgen.websphere_deploy.ORACLE_V11_1.OIDvalueBeanExtractor_9352f82e
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.god.oidgen.websphere_deploy.ORACLE_V11_1.OIDvalueBeanExtractor_9352f82e();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.god.oidgen.websphere_deploy.ORACLE_V11_1.OIDvalueBeanInjectorImpl_9352f82e();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------Alias-------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("OIDvalue", "OIDvalue1_Alias", "ORACLE", "SEQUENCES", "OIDvalue_OIDvalue1_Table", 11, 0, 0);


		//-----------------------------------Table Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[2];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("VALUE", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._NUMERIC, -1, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 38, 0, 0, false);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("ID", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 50, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "ID";
		cat[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("OIDvalue", "OIDvalue1_Table", null, fields, primarykey);


		//-----------------------------------Bean Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[2];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("nextOID", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._INTEGER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0, true);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("type", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "type";
		cat[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("OIDvalue", "OIDvalue_BO", "com.god.oidgen.OIDvalueBean", fields, primarykey);
		...
		subhomes = null;
		cat[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogView("OIDvalue", "OIDvalue_OIDvalue_BO", "OIDvalue_OIDvalue1_Alias", composedObjs, composedObjImpls, 
		"select t1.VALUE,t1.ID from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.god.oidgen.websphere_deploy.ORACLE_V11_1.OIDvalueBeanFunctionSet_9352f82e");
		...
		daSpec.setQueryScope(new String[]{"OIDvalue"});
		result.add(daSpec);
	 ...
	 * OIDvalueBeanAdaptorBinding_9352f82e
	 */
	public OIDvalueBeanAdaptorBinding_9352f82e() {
