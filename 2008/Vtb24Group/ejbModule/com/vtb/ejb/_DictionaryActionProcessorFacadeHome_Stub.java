...
public class _DictionaryActionProcessorFacadeHome_Stub extends Stub implements DictionaryActionProcessorFacadeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.vtb.ejb.DictionaryActionProcessorFacadeHome:0000000000000000", 
    ...
    public DictionaryActionProcessorFacade create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (DictionaryActionProcessorFacade) in.read_Object(DictionaryActionProcessorFacade.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.vtb.ejb.DictionaryActionProcessorFacadeHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    DictionaryActionProcessorFacade result = ((com.vtb.ejb.DictionaryActionProcessorFacadeHome)so.servant).create();
                    return (DictionaryActionProcessorFacade)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
