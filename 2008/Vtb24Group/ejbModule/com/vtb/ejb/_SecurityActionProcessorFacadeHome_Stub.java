...
public class _SecurityActionProcessorFacadeHome_Stub extends Stub implements SecurityActionProcessorFacadeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.vtb.ejb.SecurityActionProcessorFacadeHome:0000000000000000", 
    ...
    public SecurityActionProcessorFacade create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SecurityActionProcessorFacade) in.read_Object(SecurityActionProcessorFacade.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.vtb.ejb.SecurityActionProcessorFacadeHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SecurityActionProcessorFacade result = ((com.vtb.ejb.SecurityActionProcessorFacadeHome)so.servant).create();
                    return (SecurityActionProcessorFacade)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
