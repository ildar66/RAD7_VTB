...
/**
 * CommissionTypeEJBBeanFunctionSet_4217e032
 */
public class CommissionTypeEJBBeanFunctionSet_4217e032 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO COMMISSION_TYPE (ID_COMMISSION_TYPE, NAME_COMMISSION_TYPE) VALUES (?, ?)";
	/**
	 * Create
	 */
	public void Create(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		...
		try {
			...
			// For column NAME_COMMISSION_TYPE
			{
				String tempString;
	...
	private static String RemoveQuery_0 = "DELETE FROM COMMISSION_TYPE  WHERE ID_COMMISSION_TYPE = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE COMMISSION_TYPE  SET NAME_COMMISSION_TYPE = ? WHERE ID_COMMISSION_TYPE = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE COMMISSION_TYPE  SET NAME_COMMISSION_TYPE = ? WHERE ID_COMMISSION_TYPE = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.ID_COMMISSION_TYPE, T1.NAME_COMMISSION_TYPE FROM COMMISSION_TYPE  T1 WHERE T1.ID_COMMISSION_TYPE = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.ID_COMMISSION_TYPE, T1.NAME_COMMISSION_TYPE FROM COMMISSION_TYPE  T1 WHERE T1.ID_COMMISSION_TYPE = ? FOR UPDATE ";
	/**
	 ...
	 * CommissionTypeEJBBeanFunctionSet_4217e032
	 */
	public CommissionTypeEJBBeanFunctionSet_4217e032() {
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM COMMISSION_TYPE  T1 WHERE T1.ID_COMMISSION_TYPE = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM COMMISSION_TYPE  T1 WHERE T1.ID_COMMISSION_TYPE = ? FOR UPDATE ";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = CommissionTypeEJBBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
	...
	public void PartialStore(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		...
		try {
			...
			if (updateTemplateList == null)
				initializeUpdateTemplates();
			{
				com.ibm.ws.ejbdeploy.JVtb24Group.ORACLE_V11_1.RdbRuntimeUpdateTemplate aTemplate = (com.ibm.ws.ejbdeploy.JVtb24Group.ORACLE_V11_1.RdbRuntimeUpdateTemplate) updateTemplateList.get(0);
