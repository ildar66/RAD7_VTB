package com.vtb.ejb.websphere_deploy.ORACLE_V9_1;

/**
 * CommissionTypeEJBBeanAdaptorBinding_4217e032
 */
public class CommissionTypeEJBBeanAdaptorBinding_4217e032 implements com.ibm.ws.ejbpersistence.beanextensions.EJBAdapterBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.vtb.ejb.websphere_deploy.ORACLE_V9_1.CommissionTypeEJBBeanExtractor_4217e032
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.vtb.ejb.websphere_deploy.ORACLE_V9_1.CommissionTypeEJBBeanExtractor_4217e032();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.vtb.ejb.websphere_deploy.ORACLE_V9_1.CommissionTypeEJBBeanInjectorImpl_4217e032();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------Alias-------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("CommissionTypeEJB", "CommissionTypeEJB1_Alias", "ORACLE", "COMMISSION_TYPE", "CommissionTypeEJB_CommissionTypeEJB1_Table", 9, 0, 0);


		//-----------------------------------Table Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[2];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("ID_COMMISSION_TYPE", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._NUMERIC, -1, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, 0, 0, false);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("NAME_COMMISSION_TYPE", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 256, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "ID_COMMISSION_TYPE";
		cat[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("CommissionTypeEJB", "CommissionTypeEJB1_Table", null, fields, primarykey);


		//-----------------------------------Bean Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[2];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("id", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._INTEGER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("name", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "id";
		cat[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("CommissionTypeEJB", "CommissionTypeEJB_BO", "com.vtb.ejb.CommissionTypeEJBBean", fields, primarykey);
		...
		subhomes = null;
		cat[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogView("CommissionTypeEJB", "CommissionTypeEJB_CommissionTypeEJB_BO", "CommissionTypeEJB_CommissionTypeEJB1_Alias", composedObjs, composedObjImpls, 
		"select t1.ID_COMMISSION_TYPE,t1.NAME_COMMISSION_TYPE from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.vtb.ejb.websphere_deploy.ORACLE_V9_1.CommissionTypeEJBBeanFunctionSet_4217e032");
		...
		daSpec.setQueryScope(new String[]{"CommissionTypeEJB"});
		result.add(daSpec);
	 ...
	 * CommissionTypeEJBBeanAdaptorBinding_4217e032
	 */
	public CommissionTypeEJBBeanAdaptorBinding_4217e032() {
