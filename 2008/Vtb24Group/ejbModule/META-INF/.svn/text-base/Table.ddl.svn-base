...
CREATE TABLE SYSTEM.FB_ABS_ADDRESS (
...
CREATE TABLE SYSTEM.STOP_FACTORS (
...
CREATE TABLE SYSTEM.OWNERSHIP_FORM_TYPE (
...
CREATE TABLE SYSTEM.LIMIT_TYPE (
...
CREATE TABLE SYSTEM.WM$UDTRIG_INFO (
...
CREATE TABLE SYSTEM.RATING_TYPE (
...
CREATE TABLE SYSTEM.CRM_APPLICATIONS (
...
CREATE TABLE SYSTEM.CRM_CONTRACTOR (
		CONTRACTOR VARCHAR2(128) NOT NULL,
		TYPE VARCHAR2(64),
		TERRITORY VARCHAR2(64),
		STATUS VARCHAR2(64),
...
CREATE TABLE SYSTEM.STOP_FACTORS_GROUPS (
		ID_STOP_FACTORS_GROUPS NUMBER NOT NULL,
...
CREATE TABLE SYSTEM.TYPEOFDOCUMENT (
...
CREATE TABLE SYSTEM.COMPANYEJB (
...
CREATE TABLE SYSTEM.WM$LOCKROWS_INFO (
...
CREATE TABLE SYSTEM.META_SIMPLEVOCABULARY (
...
CREATE TABLE SYSTEM.SHAREHOLDERS (
...
CREATE TABLE SYSTEM.CONTRACTOR_TYPE (
...
CREATE TABLE SYSTEM.APPLICATIONFILES (
...
CREATE TABLE SYSTEM.CONTRACTORS (
		ID_CONTRACTOR NUMBER NOT NULL,
		ID_CONTRACTOR_TYPE NUMBER NOT NULL
	)
	LOGGING;
...
CREATE TABLE SYSTEM.WM$ENV_VARS (
		NAME VARCHAR2(100),
		VALUE VARCHAR2(4000)
	)
	LOGGING;
...
CREATE TABLE SYSTEM.DOCUMENTS_TYPE (
...
CREATE TABLE SYSTEM.FILE_REQUEST (
...
CREATE TABLE SYSTEM.WORKPOSITIONEJB (
...
CREATE TABLE SYSTEM.TARGET_TYPE (
...
CREATE TABLE SYSTEM.PATTERN_DOCS (
		TYPE VARCHAR2(64),
...
CREATE TABLE SYSTEM.STOP_FACTOR_FOR_CONTRACTOR (
		ID_STOP_FACTOR NUMBER NOT NULL,
		ID_CONTRACTOR NUMBER NOT NULL,
		VALUE NUMBER,
...
CREATE TABLE SYSTEM.FB_ACCOUNT (
		ACCOUNTID CHAR(12) NOT NULL,
		CREATEUSER CHAR(12),
		CREATEDATE DATE,
		MODIFYUSER CHAR(12),
...
CREATE TABLE SYSTEM.OPERATOREJB (
...
CREATE TABLE SYSTEM.COMMISSION_TYPE (
...
CREATE TABLE SYSTEM.LINK_OWNFORM_DOCTYPE (
		ID_OWNERSHIP_FORM_TYPE NUMBER NOT NULL,
		ID_DOCUMENT_TYPE NUMBER NOT NULL
	)
	LOGGING;

CREATE TABLE SYSTEM.PATTERN_INTEREST_RATE (
...
CREATE TABLE SYSTEM.PATTERN_PAID_PERCENT_TYPE (
...
CREATE TABLE SYSTEM.SPO_SETTINGS (
		ID_DEPARTMENT NUMBER NOT NULL,
...
CREATE TABLE SYSTEM.DIVISIONEJB (
...
CREATE TABLE SYSTEM.PROFILEEJB (
...
CREATE UNIQUE INDEX SYSTEM.REPCAT$_RESOLUTION_PK ON SYSTEM.REPCAT$_RESOLUTION (SNAME ASC, ONAME ASC, CONFLICT_TYPE_ID ASC, REFERENCE_NAME ASC, SEQUENCE_NO ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_RESOLUTION_F3_IDX ON SYSTEM.REPCAT$_RESOLUTION (CONFLICT_TYPE_ID ASC, METHOD_NAME ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_RESOLUTION_IDX2 ON SYSTEM.REPCAT$_RESOLUTION (SNAME ASC, ONAME ASC, CONFLICT_TYPE_ID ASC, REFERENCE_NAME ASC)
	LOGGING;

CREATE INDEX SYSTEM.PK_MESSAGE ON SYSTEM.MESSAGE (IDMESSAGE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_DEPARTMENTS ON SYSTEM.DEPARTMENTS (ID_DEPARTMENT ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_REPGROUP_PRIVS_UK ON SYSTEM.REPCAT$_REPGROUP_PRIVS (USERNAME ASC, GNAME ASC, GOWNER ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPGROUP_PRIVS_N1 ON SYSTEM.REPCAT$_REPGROUP_PRIVS (GLOBAL_FLAG ASC, USERNAME ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPGROUP_PRIVS_FK_IDX ON SYSTEM.REPCAT$_REPGROUP_PRIVS (GNAME ASC, GOWNER ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1COLTYPE$ ON SYSTEM.LOGMNR_COLTYPE$ (LOGMNR_UID ASC, OBJ# ASC, INTCOL# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_FLAVOR_OBJECTS_PK ON SYSTEM.REPCAT$_FLAVOR_OBJECTS (SNAME ASC, ONAME ASC, TYPE ASC, GNAME ASC, FLAVOR_ID ASC, GOWNER ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_FLAVOR_OBJECTS_FG ON SYSTEM.REPCAT$_FLAVOR_OBJECTS (FLAVOR_ID ASC, GNAME ASC, GOWNER ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_FLAVOR_OBJECTS_FK1_IDX ON SYSTEM.REPCAT$_FLAVOR_OBJECTS (GNAME ASC, GOWNER ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_FLAVOR_OBJECTS_FK2_IDX ON SYSTEM.REPCAT$_FLAVOR_OBJECTS (GNAME ASC, FLAVOR_ID ASC, GOWNER ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_RESOL_STATS_CTRL_PK ON SYSTEM.REPCAT$_RESOL_STATS_CONTROL (SNAME ASC, ONAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.UNQ_PAIRS ON SYSTEM.AQ$_INTERNET_AGENT_PRIVS (AGENT_NAME ASC, DB_USERNAME ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1ICOL$ ON SYSTEM.LOGMNR_ICOL$ (LOGMNR_UID ASC, OBJ# ASC, INTCOL# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.DEF$_LOB_PRIMARY ON SYSTEM.DEF$_LOB (ID ASC)
	LOGGING;

CREATE INDEX SYSTEM.DEF$_LOB_N1 ON SYSTEM.DEF$_LOB (ENQ_TID ASC)
	LOGGING;

CREATE INDEX SYSTEM.MVIEW$_ADV_SQLDEPEND_IDX_01 ON SYSTEM.MVIEW$_ADV_SQLDEPEND (COLLECTIONID# ASC, FROM_ADDRESS ASC, FROM_HASH ASC, INST_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.DEF$_DEFAULTDEST_PRIMARY ON SYSTEM.DEF$_DEFAULTDEST (DBLINK ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.NID ON SYSTEM.USERBANK (NID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_AUDIT_COLUMN_PK ON SYSTEM.REPCAT$_AUDIT_COLUMN (COLUMN_NAME ASC, ONAME ASC, SNAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_FB_ABS_ADDRESS ON SYSTEM.FB_ABS_ADDRESS (ACCOUNTID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_RUNTIME_PARMS_PK ON SYSTEM.REPCAT$_RUNTIME_PARMS (RUNTIME_PARM_ID ASC, PARAMETER_NAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_LEVEL_PK ON SYSTEM.MVIEW$_ADV_LEVEL (RUNID# ASC, LEVELID# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_MANAGERS ON SYSTEM.MANAGERS (ID_MANAGER ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_COLUMN_GROUP_PK ON SYSTEM.REPCAT$_COLUMN_GROUP (SNAME ASC, ONAME ASC, GROUP_NAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_PARAMETERS_PK ON SYSTEM.MVIEW$_ADV_PARAMETERS (PARAMETER_NAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_REPOBJECT_PRIMARY ON SYSTEM.REPCAT$_REPOBJECT (SNAME ASC, ONAME ASC, TYPE ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPOBJECT_GNAME ON SYSTEM.REPCAT$_REPOBJECT (GNAME ASC, ONAME ASC, TYPE ASC, GOWNER ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPOBJECT_PRNT_IDX ON SYSTEM.REPCAT$_REPOBJECT (GNAME ASC, GOWNER ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1TAB$ ON SYSTEM.LOGMNR_TAB$ (LOGMNR_UID ASC, OBJ# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_PRIORITY_GROUP_PK ON SYSTEM.REPCAT$_PRIORITY_GROUP (PRIORITY_GROUP ASC, SNAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_PRIORITY_GROUP_U1 ON SYSTEM.REPCAT$_PRIORITY_GROUP (SNAME ASC, PRIORITY_GROUP ASC, DATA_TYPE_ID ASC, FIXED_DATA_LENGTH ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1USER$ ON SYSTEM.LOGMNR_USER$ (LOGMNR_UID ASC, USER# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_ACCOUNT ON SYSTEM.ACCOUNT (ACCOUNTID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_APPFILES ON SYSTEM.APPFILES (UNID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.HELP_TOPIC_SEQ ON SYSTEM.HELP (TOPIC ASC, SEQ ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_REPCAT_PRIMARY ON SYSTEM.REPCAT$_REPCAT (SNAME ASC, GOWNER ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_OBJECT_TYPE_PK ON SYSTEM.REPCAT$_OBJECT_TYPES (OBJECT_TYPE_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_SEQUENCES ON SYSTEM.SEQUENCES (ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_STOP_FACTORS ON SYSTEM.STOP_FACTORS (ID_STOP_FACTOR ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_OWNERSHIP_FORM_TYPE ON SYSTEM.OWNERSHIP_FORM_TYPE (ID_OWNERSHIP_FORM_TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_INSTANTIATION_DDL_PK ON SYSTEM.REPCAT$_INSTANTIATION_DDL (REFRESH_TEMPLATE_ID ASC, PHASE ASC, DDL_NUM ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_LIMIT_TYPE ON SYSTEM.LIMIT_TYPE (ID_LIMIT_TYPE ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1CCOL$ ON SYSTEM.LOGMNR_CCOL$ (LOGMNR_UID ASC, CON# ASC, INTCOL# ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1TYPE$ ON SYSTEM.LOGMNR_TYPE$ (LOGMNR_UID ASC, TOID ASC, VERSION# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.WM$UDTRIG_INFO_PK ON SYSTEM.WM$UDTRIG_INFO (TRIG_OWNER_NAME ASC, TRIG_NAME ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPCATLOG_GNAME ON SYSTEM.REPCAT$_REPCATLOG (GNAME ASC, SNAME ASC, ONAME ASC, TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_REPCATLOG_PRIMARY ON SYSTEM.REPCAT$_REPCATLOG (ID ASC, SOURCE ASC, ROLE ASC, MASTER ASC)
	LOGGING;

CREATE INDEX SYSTEM.MVIEW$_ADV_TEMP_IDX_01 ON SYSTEM.MVIEW$_ADV_TEMP (ID# ASC, SEQ# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_OUTPUT_PK ON SYSTEM.MVIEW$_ADV_OUTPUT (RUNID# ASC, RANK# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_TEMPLATE_SITES_PK ON SYSTEM.REPCAT$_TEMPLATE_SITES (TEMPLATE_SITE_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_TEMPLATE_SITES_U1 ON SYSTEM.REPCAT$_TEMPLATE_SITES (REFRESH_TEMPLATE_NAME ASC, USER_NAME ASC, SITE_NAME ASC, REPAPI_SITE_ID ASC)
	LOGGING;

CREATE INDEX SYSTEM.DEF$_TRANORDER ON SYSTEM.DEF$_AQCALL (CSCN ASC, ENQ_TID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_EXCEPTIONS_PK ON SYSTEM.REPCAT$_EXCEPTIONS (EXCEPTION_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_RATING ON SYSTEM.RATING_TYPE (ID_RATING_TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.I_REPCAT$_SNAPGROUP1 ON SYSTEM.REPCAT$_SNAPGROUP (GNAME ASC, DBLINK ASC, GOWNER ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.TEMPLATE$_TARGETS_PK ON SYSTEM.REPCAT$_TEMPLATE_TARGETS (TEMPLATE_TARGET_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_TEMPLATE_TARGETS_U1 ON SYSTEM.REPCAT$_TEMPLATE_TARGETS (TARGET_DATABASE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_FJG_PK ON SYSTEM.MVIEW$_ADV_FJG (FJGID# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_LOG_PK ON SYSTEM.MVIEW$_ADV_LOG (RUNID# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.DEF$_DESTINATION_PRIMARY ON SYSTEM.DEF$_DESTINATION (DBLINK ASC, CATCHUP ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1COL$ ON SYSTEM.LOGMNR_COL$ (LOGMNR_UID ASC, OBJ# ASC, INTCOL# ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I2COL$ ON SYSTEM.LOGMNR_COL$ (LOGMNR_UID ASC, OBJ# ASC, NAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.ID ON SYSTEM.CRM_APPLICATIONS (ID_APPLICATION ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_PRIORITY_PK ON SYSTEM.REPCAT$_PRIORITY (SNAME ASC, PRIORITY_GROUP ASC, PRIORITY ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_PRIORITY_F1_IDX ON SYSTEM.REPCAT$_PRIORITY (PRIORITY_GROUP ASC, SNAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_ROLEEJB ON SYSTEM.ROLEEJB (ROLE1 ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.CONTRACTOR ON SYSTEM.CRM_CONTRACTOR (CONTRACTOR ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_STOP_FACTORS_GROUPS ON SYSTEM.STOP_FACTORS_GROUPS (ID_STOP_FACTORS_GROUPS ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_FILTER_PK ON SYSTEM.MVIEW$_ADV_FILTER (FILTERID# ASC, SUBFILTERNUM# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.AQ$_QUEUES_PRIMARY ON SYSTEM.AQ$_QUEUES (OID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.AQ$_QUEUES_CHECK ON SYSTEM.AQ$_QUEUES (NAME ASC, TABLE_OBJNO ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_AUDIT_ATTRIBUTE_PK ON SYSTEM.REPCAT$_AUDIT_ATTRIBUTE (ATTRIBUTE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.DEF$_ERROR_PRIMARY ON SYSTEM.DEF$_ERROR (ENQ_TID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_COMPANYEJB ON SYSTEM.COMPANYEJB (COMPANY ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1TABCOMPART$ ON SYSTEM.LOGMNR_TABCOMPART$ (LOGMNR_UID ASC, OBJ# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_ORGANIZATIONS ON SYSTEM.ORGANIZATIONS (ID_CONTRACTOR ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_CONSTR_ROLES ON SYSTEM.ROLES (ID_ROLES ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_CLIQUE_PK ON SYSTEM.MVIEW$_ADV_CLIQUE (CLIQUEID# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_META_SIMPLEVOCABULARY ON SYSTEM.META_SIMPLEVOCABULARY (ID_VOCABULARY ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_SHAREHOLDERS ON SYSTEM.SHAREHOLDERS (ID_SHAREHOLDER ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_SITES_NEW_PK ON SYSTEM.REPCAT$_SITES_NEW (EXTENSION_ID ASC, GOWNER ASC, GNAME ASC, DBLINK ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_SITES_NEW_FK2_IDX ON SYSTEM.REPCAT$_SITES_NEW (GNAME ASC, GOWNER ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_SITES_NEW_FK1_IDX ON SYSTEM.REPCAT$_SITES_NEW (EXTENSION_ID ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1ATTRCOL$ ON SYSTEM.LOGMNR_ATTRCOL$ (LOGMNR_UID ASC, OBJ# ASC, INTCOL# ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1TABSUBPART$ ON SYSTEM.LOGMNR_TABSUBPART$ (LOGMNR_UID ASC, OBJ# ASC, POBJ# ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPCOLUMN_FK_IDX ON SYSTEM.REPCAT$_REPCOLUMN (SNAME ASC, ONAME ASC, TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_REPCOLUMN_PK ON SYSTEM.REPCAT$_REPCOLUMN (SNAME ASC, ONAME ASC, TYPE ASC, CNAME ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1OBJ$ ON SYSTEM.LOGMNR_OBJ$ (LOGMNR_UID ASC, OBJ# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_USER_PARM_VALUES_PK ON SYSTEM.REPCAT$_USER_PARM_VALUES (USER_PARAMETER_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_USER_PARM_VALUES_U1 ON SYSTEM.REPCAT$_USER_PARM_VALUES (TEMPLATE_PARAMETER_ID ASC, USER_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.DEF$_PUSHED_TRAN_PRIMARY ON SYSTEM.DEF$_PUSHED_TRANSACTIONS (SOURCE_SITE_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_MSUSEREJB ON SYSTEM.MSUSEREJB (MSUCODE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_CONTRACTOR_TYPE ON SYSTEM.CONTRACTOR_TYPE (ID_CONTRACTOR_TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_GROUPED_COLUMN_PK ON SYSTEM.REPCAT$_GROUPED_COLUMN (SNAME ASC, ONAME ASC, GROUP_NAME ASC, COLUMN_NAME ASC, POS ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_GROUPED_COLUMN_F1_IDX ON SYSTEM.REPCAT$_GROUPED_COLUMN (SNAME ASC, ONAME ASC, GROUP_NAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_USER_AUTHORIZATIONS_PK ON SYSTEM.REPCAT$_USER_AUTHORIZATIONS (USER_AUTHORIZATION_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_USER_AUTHORIZATIONS_U1 ON SYSTEM.REPCAT$_USER_AUTHORIZATIONS (USER_ID ASC, REFRESH_TEMPLATE_ID ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_USER_AUTHORIZATIONS_N1 ON SYSTEM.REPCAT$_USER_AUTHORIZATIONS (REFRESH_TEMPLATE_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_FLAVORS_UNQ1 ON SYSTEM.REPCAT$_FLAVORS (GNAME ASC, FLAVOR_ID ASC, GOWNER ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_FLAVORS_FNAME ON SYSTEM.REPCAT$_FLAVORS (FNAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_FLAVORS_GNAME ON SYSTEM.REPCAT$_FLAVORS (GNAME ASC, FNAME ASC, GOWNER ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_FLAVORS_FK1_IDX ON SYSTEM.REPCAT$_FLAVORS (GNAME ASC, GOWNER ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_RESOLUTION_STATS_N1 ON SYSTEM.REPCAT$_RESOLUTION_STATISTICS (SNAME ASC, ONAME ASC, RESOLVED_DATE ASC, CONFLICT_TYPE_ID ASC, REFERENCE_NAME ASC, METHOD_NAME ASC, FUNCTION_NAME ASC, PRIORITY_GROUP ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_CONTRACTORS ON SYSTEM.CONTRACTORS (ID_CONTRACTOR ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_GC_PK ON SYSTEM.MVIEW$_ADV_GC (GCID# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_ROLLUP_PK ON SYSTEM.MVIEW$_ADV_ROLLUP (RUNID# ASC, CLEVELID# ASC, PLEVELID# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_TEMPLATE_PARMS_PK ON SYSTEM.REPCAT$_TEMPLATE_PARMS (TEMPLATE_PARAMETER_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_TEMPLATE_PARMS_U1 ON SYSTEM.REPCAT$_TEMPLATE_PARMS (REFRESH_TEMPLATE_ID ASC, PARAMETER_NAME ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_DDL_INDEX ON SYSTEM.REPCAT$_DDL (LOG_ID ASC, SOURCE ASC, ROLE ASC, MASTER ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_DDL ON SYSTEM.REPCAT$_DDL (LOG_ID ASC, SOURCE ASC, ROLE ASC, MASTER ASC, LINE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_SITE_OBJECTS_U1 ON SYSTEM.REPCAT$_SITE_OBJECTS (TEMPLATE_SITE_ID ASC, ONAME ASC, OBJECT_TYPE_ID ASC, SNAME ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_SITE_OBJECTS_N1 ON SYSTEM.REPCAT$_SITE_OBJECTS (TEMPLATE_SITE_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_PARAMETER_COLUMN_PK ON SYSTEM.REPCAT$_PARAMETER_COLUMN (SNAME ASC, ONAME ASC, CONFLICT_TYPE_ID ASC, REFERENCE_NAME ASC, SEQUENCE_NO ASC, PARAMETER_TABLE_NAME ASC, PARAMETER_SEQUENCE_NO ASC, COLUMN_POS ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_PARAMETER_COLUMN_F1_I ON SYSTEM.REPCAT$_PARAMETER_COLUMN (SNAME ASC, ONAME ASC, CONFLICT_TYPE_ID ASC, REFERENCE_NAME ASC, SEQUENCE_NO ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1TABPART$ ON SYSTEM.LOGMNR_TABPART$ (LOGMNR_UID ASC, OBJ# ASC, BO# ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1LOB$ ON SYSTEM.LOGMNR_LOB$ (LOGMNR_UID ASC, OBJ# ASC, INTCOL# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.AQ$_QUEUE_TABLES_PRIMARY ON SYSTEM.AQ$_QUEUE_TABLES (OBJNO ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_DOCUMENT_TYPE ON SYSTEM.DOCUMENTS_TYPE (ID_DOCUMENT_TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_FILE_REQUEST ON SYSTEM.FILE_REQUEST (ID_REQUEST ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_WORKLOAD_PK ON SYSTEM.MVIEW$_ADV_WORKLOAD (QUERYID# ASC)
	LOGGING;

CREATE INDEX SYSTEM.MVIEW$_ADV_WORKLOAD_IDX_01 ON SYSTEM.MVIEW$_ADV_WORKLOAD (COLLECTIONID# ASC, QUERYID# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_WORKPOSITIONEJB ON SYSTEM.WORKPOSITIONEJB (WORKPOSITION ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_TARGET_TYPE ON SYSTEM.TARGET_TYPE (ID_TARGET_TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.DEF$_PROPAGATOR_PRIMARY ON SYSTEM.DEF$_PROPAGATOR (USERID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_PATTERN ON SYSTEM.PATTERN_DOCS (ID_PATTERN ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_STOP_FACTOR_FOR_CONTRACTOR ON SYSTEM.STOP_FACTOR_FOR_CONTRACTOR (ID_STOP_FACTOR ASC, ID_CONTRACTOR ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_TEMPLATE_REFGROUPS_PK ON SYSTEM.REPCAT$_TEMPLATE_REFGROUPS (REFRESH_GROUP_ID ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_TEMPLATE_REFGROUPS_N1 ON SYSTEM.REPCAT$_TEMPLATE_REFGROUPS (REFRESH_GROUP_NAME ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_TEMPLATE_REFGROUPS_N2 ON SYSTEM.REPCAT$_TEMPLATE_REFGROUPS (REFRESH_TEMPLATE_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_AJG_PK ON SYSTEM.MVIEW$_ADV_AJG (AJGID# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_JOURNAL_PK ON SYSTEM.MVIEW$_ADV_JOURNAL (RUNID# ASC, SEQ# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_TEMPLATE_STATUS_PK ON SYSTEM.REPCAT$_TEMPLATE_STATUS (TEMPLATE_STATUS_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_OPERATOREJB ON SYSTEM.OPERATOREJB (OPERATOR ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_REPPROP_PRIMARY ON SYSTEM.REPCAT$_REPPROP (SNAME ASC, ONAME ASC, TYPE ASC, DBLINK ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPPROP_DBLINK_HOW ON SYSTEM.REPCAT$_REPPROP (DBLINK ASC, HOW ASC, EXTENSION_ID ASC, RECIPIENT_KEY ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPPROP_KEY_INDEX ON SYSTEM.REPCAT$_REPPROP (RECIPIENT_KEY ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPPROP_PRNT_IDX ON SYSTEM.REPCAT$_REPPROP (SNAME ASC, ONAME ASC, TYPE ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPPROP_PRNT2_IDX ON SYSTEM.REPCAT$_REPPROP (SNAME ASC, DBLINK ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1IND$ ON SYSTEM.LOGMNR_IND$ (LOGMNR_UID ASC, OBJ# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_COMMISSION_TYPE ON SYSTEM.COMMISSION_TYPE (ID_COMMISSION_TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.MVIEW$_ADV_ELIGIBLE_PK ON SYSTEM.MVIEW$_ADV_ELIGIBLE (SUMOBJN# ASC, RUNID# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_LINK_OWNFORM_DOCTYPE ON SYSTEM.LINK_OWNFORM_DOCTYPE (ID_DOCUMENT_TYPE ASC, ID_OWNERSHIP_FORM_TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_PATTERN_INTEREST_RATE ON SYSTEM.PATTERN_INTEREST_RATE (ID_PATTERN_INTEREST_RATE ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1TS$ ON SYSTEM.LOGMNR_TS$ (LOGMNR_UID ASC, TS# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_OBJECT_PARMS_PK ON SYSTEM.REPCAT$_OBJECT_PARMS (TEMPLATE_PARAMETER_ID ASC, TEMPLATE_OBJECT_ID ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_OBJECT_PARMS_N2 ON SYSTEM.REPCAT$_OBJECT_PARMS (TEMPLATE_OBJECT_ID ASC)
	LOGGING;

CREATE INDEX SYSTEM.LOGMNR_I1CDEF$ ON SYSTEM.LOGMNR_CDEF$ (LOGMNR_UID ASC, CON# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_TEMPLATE_TYPES_PK ON SYSTEM.REPCAT$_TEMPLATE_TYPES (TEMPLATE_TYPE_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_CONFLICT_PK ON SYSTEM.REPCAT$_CONFLICT (SNAME ASC, ONAME ASC, CONFLICT_TYPE_ID ASC, REFERENCE_NAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_TEMPLATE_OBJECTS_PK ON SYSTEM.REPCAT$_TEMPLATE_OBJECTS (TEMPLATE_OBJECT_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_TEMPLATE_OBJECTS_U1 ON SYSTEM.REPCAT$_TEMPLATE_OBJECTS (OBJECT_NAME ASC, OBJECT_TYPE ASC, REFRESH_TEMPLATE_ID ASC, SCHEMA_NAME ASC, DDL_NUM ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_TEMPLATE_OBJECTS_N1 ON SYSTEM.REPCAT$_TEMPLATE_OBJECTS (REFRESH_TEMPLATE_ID ASC, OBJECT_TYPE ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_TEMPLATE_OBJECTS_N2 ON SYSTEM.REPCAT$_TEMPLATE_OBJECTS (REFRESH_TEMPLATE_ID ASC, OBJECT_NAME ASC, SCHEMA_NAME ASC, OBJECT_TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_RESOL_METHOD_PK ON SYSTEM.REPCAT$_RESOLUTION_METHOD (CONFLICT_TYPE_ID ASC, METHOD_NAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_OPPORTUNITY_TYPE ON SYSTEM.OPPORTUNITY_TYPE (ID_OPPORTUNITY_TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_PEOPLEEJB ON SYSTEM.PEOPLEEJB (MAN ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_REPGEN_PRIMARY ON SYSTEM.REPCAT$_GENERATED (SNAME ASC, ONAME ASC, TYPE ASC, BASE_SNAME ASC, BASE_ONAME ASC, BASE_TYPE ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_GENERATED_N1 ON SYSTEM.REPCAT$_GENERATED (BASE_SNAME ASC, BASE_ONAME ASC, BASE_TYPE ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPGEN_PRNT_IDX ON SYSTEM.REPCAT$_GENERATED (SNAME ASC, ONAME ASC, TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_REPSCHEMA_PRIMARY ON SYSTEM.REPCAT$_REPSCHEMA (SNAME ASC, DBLINK ASC, GOWNER ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPSCHEMA_DEST_IDX ON SYSTEM.REPCAT$_REPSCHEMA (DBLINK ASC, EXTENSION_ID ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_REPSCHEMA_PRNT_IDX ON SYSTEM.REPCAT$_REPSCHEMA (SNAME ASC, GOWNER ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_WORKEREJB ON SYSTEM.WORKEREJB (WORKER ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_REFRESH_TEMPLATES_PK ON SYSTEM.REPCAT$_REFRESH_TEMPLATES (REFRESH_TEMPLATE_ID ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_REFRESH_TEMPLATES_U1 ON SYSTEM.REPCAT$_REFRESH_TEMPLATES (REFRESH_TEMPLATE_NAME ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.DEF$_CALLDEST_PRIMARY ON SYSTEM.DEF$_CALLDEST (ENQ_TID ASC, DBLINK ASC, STEP_NO ASC)
	LOGGING;

CREATE INDEX SYSTEM.DEF$_CALLDEST_N2 ON SYSTEM.DEF$_CALLDEST (DBLINK ASC, CATCHUP ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_PATTERN_PAID_PERCENT_TYPE ON SYSTEM.PATTERN_PAID_PERCENT_TYPE (ID_PAID_PERCENT_TYPE ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.REPCAT$_KEY_COLUMNS_PRIMARY ON SYSTEM.REPCAT$_KEY_COLUMNS (SNAME ASC, ONAME ASC, COL ASC)
	LOGGING;

CREATE INDEX SYSTEM.REPCAT$_KEY_COLUMNS_PRNT_IDX ON SYSTEM.REPCAT$_KEY_COLUMNS (SNAME ASC, ONAME ASC, TYPE ASC)
	LOGGING;

CREATE INDEX SYSTEM.MVIEW$_ADV_PRETTY_IDX_01 ON SYSTEM.MVIEW$_ADV_PRETTY (QUERYID# ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_SPO_SETTINGS ON SYSTEM.SPO_SETTINGS (ID_DEPARTMENT ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.AQ$_SCHEDULES_PRIMARY ON SYSTEM.AQ$_SCHEDULES (OID ASC, DESTINATION ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.AQ$_SCHEDULES_CHECK ON SYSTEM.AQ$_SCHEDULES (JOBNO ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_DIVISIONEJB ON SYSTEM.DIVISIONEJB (DIVISION ASC)
	LOGGING;

CREATE UNIQUE INDEX SYSTEM.PK_PROFILEEJB ON SYSTEM.PROFILEEJB (OPERATORID ASC, KEY1 ASC, NAME ASC)
	LOGGING;
...
ALTER TABLE SYSTEM.MESSAGE ADD CONSTRAINT XPK_MESSAGE PRIMARY KEY (IDMESSAGE);

ALTER TABLE SYSTEM.DEPARTMENTS ADD CONSTRAINT PK_DEPARTMENTS PRIMARY KEY (ID_DEPARTMENT);

ALTER TABLE SYSTEM.REPCAT$_REPGROUP_PRIVS ADD CONSTRAINT REPCAT$_REPGROUP_PRIVS_UK UNIQUE (USERNAME, GNAME, GOWNER);

ALTER TABLE SYSTEM.LOGMNR_COLTYPE$ ADD CONSTRAINT SYS_C001055 PRIMARY KEY (LOGMNR_UID, OBJ#, INTCOL#);
...
ALTER TABLE SYSTEM.LOGMNR_UID$ ADD CONSTRAINT SYS_C001042 PRIMARY KEY (SESSION#);

ALTER TABLE SYSTEM.LOGMNR_ICOL$ ADD CONSTRAINT SYS_C001060 PRIMARY KEY (LOGMNR_UID, OBJ#, INTCOL#);

ALTER TABLE SYSTEM.DEF$_LOB ADD CONSTRAINT DEF$_LOB_PRIMARY PRIMARY KEY (ID);

ALTER TABLE SYSTEM.LOGMNR_LOG$ ADD CONSTRAINT SYS_C001061 PRIMARY KEY (SESSION#, THREAD#, SEQUENCE#);

ALTER TABLE SYSTEM.DEF$_DEFAULTDEST ADD CONSTRAINT DEF$_DEFAULTDEST_PRIMARY PRIMARY KEY (DBLINK);

ALTER TABLE SYSTEM.USERBANK ADD CONSTRAINT NID PRIMARY KEY (NID);

ALTER TABLE SYSTEM.REPCAT$_AUDIT_COLUMN ADD CONSTRAINT REPCAT$_AUDIT_COLUMN_PK PRIMARY KEY (COLUMN_NAME, ONAME, SNAME);

ALTER TABLE SYSTEM.FB_ABS_ADDRESS ADD CONSTRAINT PK_FB_ABS_ADDRESS PRIMARY KEY (ACCOUNTID);

ALTER TABLE SYSTEM.MVIEW$_ADV_LEVEL ADD CONSTRAINT MVIEW$_ADV_LEVEL_PK PRIMARY KEY (RUNID#, LEVELID#);

ALTER TABLE SYSTEM.MANAGERS ADD CONSTRAINT PK_MANAGERS PRIMARY KEY (ID_MANAGER);
...
ALTER TABLE SYSTEM.LOGMNR_TAB$ ADD CONSTRAINT SYS_C001045 PRIMARY KEY (LOGMNR_UID, OBJ#);
...
ALTER TABLE SYSTEM.LOGMNR_USER$ ADD CONSTRAINT SYS_C001050 PRIMARY KEY (LOGMNR_UID, USER#);

ALTER TABLE SYSTEM.ACCOUNT ADD CONSTRAINT PK_ACCOUNT PRIMARY KEY (ACCOUNTID);

ALTER TABLE SYSTEM.APPFILES ADD CONSTRAINT PK_APPFILES PRIMARY KEY (UNID);

ALTER TABLE SYSTEM.LOGMNR_DICTIONARY$ ADD CONSTRAINT SYS_C001043 PRIMARY KEY (LOGMNR_UID);
...
ALTER TABLE SYSTEM.STOP_FACTORS ADD CONSTRAINT PK_STOP_FACTORS PRIMARY KEY (ID_STOP_FACTOR);

ALTER TABLE SYSTEM.OWNERSHIP_FORM_TYPE ADD CONSTRAINT PK_OWNERSHIP_FORM_TYPE PRIMARY KEY (ID_OWNERSHIP_FORM_TYPE);
...
ALTER TABLE SYSTEM.LIMIT_TYPE ADD CONSTRAINT PK_LIMIT_TYPE PRIMARY KEY (ID_LIMIT_TYPE);

ALTER TABLE SYSTEM.LOGMNR_CCOL$ ADD CONSTRAINT SYS_C001059 PRIMARY KEY (LOGMNR_UID, CON#, INTCOL#);

ALTER TABLE SYSTEM.LOGMNR_TYPE$ ADD CONSTRAINT SYS_C001054 PRIMARY KEY (LOGMNR_UID, TOID, VERSION#);

ALTER TABLE SYSTEM.WM$UDTRIG_INFO ADD CONSTRAINT WM$UDTRIG_INFO_PK PRIMARY KEY (TRIG_OWNER_NAME, TRIG_NAME);

ALTER TABLE SYSTEM.APPLICATIONS ADD CONSTRAINT SYS_C002728 PRIMARY KEY (IDAPPLICATION);
...
ALTER TABLE SYSTEM.DEF$_AQCALL ADD CONSTRAINT SYS_C001025 PRIMARY KEY (ENQ_TID, STEP_NO);

ALTER TABLE SYSTEM.REPCAT$_EXCEPTIONS ADD CONSTRAINT REPCAT$_EXCEPTIONS_PK PRIMARY KEY (EXCEPTION_ID);

ALTER TABLE SYSTEM.RATING_TYPE ADD CONSTRAINT PK_RATING PRIMARY KEY (ID_RATING_TYPE);

ALTER TABLE SYSTEM.REPCAT$_TEMPLATE_TARGETS ADD CONSTRAINT TEMPLATE$_TARGETS_PK PRIMARY KEY (TEMPLATE_TARGET_ID);

ALTER TABLE SYSTEM.REPCAT$_EXTENSION ADD CONSTRAINT SYS_C001243 PRIMARY KEY (EXTENSION_ID);
...
ALTER TABLE SYSTEM.LOGMNR_COL$ ADD CONSTRAINT SYS_C001046 PRIMARY KEY (LOGMNR_UID, OBJ#, INTCOL#);

ALTER TABLE SYSTEM.CRM_APPLICATIONS ADD CONSTRAINT ID PRIMARY KEY (ID_APPLICATION);

ALTER TABLE SYSTEM.REPCAT$_PRIORITY ADD CONSTRAINT REPCAT$_PRIORITY_PK PRIMARY KEY (SNAME, PRIORITY_GROUP, PRIORITY);

ALTER TABLE SYSTEM.ROLEEJB ADD CONSTRAINT PK_ROLEEJB PRIMARY KEY (ROLE1);

ALTER TABLE SYSTEM.CRM_CONTRACTOR ADD CONSTRAINT CONTRACTOR PRIMARY KEY (CONTRACTOR);

ALTER TABLE SYSTEM.STOP_FACTORS_GROUPS ADD CONSTRAINT PK_STOP_FACTORS_GROUPS PRIMARY KEY (ID_STOP_FACTORS_GROUPS);
...
ALTER TABLE SYSTEM.LOGMNR_DICTSTATE$ ADD CONSTRAINT SYS_C001041 PRIMARY KEY (LOGMNR_UID);

ALTER TABLE SYSTEM.TYPEOFDOCUMENT ADD CONSTRAINT SYS_C002733 PRIMARY KEY (IDTYPE);

ALTER TABLE SYSTEM.DEF$_ERROR ADD CONSTRAINT DEF$_ERROR_PRIMARY PRIMARY KEY (ENQ_TID);

ALTER TABLE SYSTEM.RUSBANK ADD CONSTRAINT SYS_C002725 PRIMARY KEY (ID);

ALTER TABLE SYSTEM.RUSBANK ADD CONSTRAINT SYS_C002726 UNIQUE (ID);

ALTER TABLE SYSTEM.COMPANYEJB ADD CONSTRAINT PK_COMPANYEJB PRIMARY KEY (COMPANY);

ALTER TABLE SYSTEM.LOGMNR_TABCOMPART$ ADD CONSTRAINT SYS_C001053 PRIMARY KEY (LOGMNR_UID, OBJ#);

ALTER TABLE SYSTEM.ORGANIZATIONS ADD CONSTRAINT PK_ORGANIZATIONS PRIMARY KEY (ID_CONTRACTOR);

ALTER TABLE SYSTEM.ROLES ADD CONSTRAINT PK_CONSTR_ROLES PRIMARY KEY (ID_ROLES);

ALTER TABLE SYSTEM.MVIEW$_ADV_CLIQUE ADD CONSTRAINT MVIEW$_ADV_CLIQUE_PK PRIMARY KEY (CLIQUEID#);

ALTER TABLE SYSTEM.META_SIMPLEVOCABULARY ADD CONSTRAINT PK_META_SIMPLEVOCABULARY PRIMARY KEY (ID_VOCABULARY);

ALTER TABLE SYSTEM.SHAREHOLDERS ADD CONSTRAINT PK_SHAREHOLDERS PRIMARY KEY (ID_SHAREHOLDER);

ALTER TABLE SYSTEM.REPCAT$_SITES_NEW ADD CONSTRAINT REPCAT$_SITES_NEW_PK PRIMARY KEY (EXTENSION_ID, GOWNER, GNAME, DBLINK);

ALTER TABLE SYSTEM.LOGMNR_ATTRCOL$ ADD CONSTRAINT SYS_C001047 PRIMARY KEY (LOGMNR_UID, OBJ#, INTCOL#);

ALTER TABLE SYSTEM.LOGMNR_PROCESSED_LOG$ ADD CONSTRAINT SYS_C001062 PRIMARY KEY (SESSION#, THREAD#);

ALTER TABLE SYSTEM.LOGMNR_TABSUBPART$ ADD CONSTRAINT SYS_C001052 PRIMARY KEY (LOGMNR_UID, OBJ#, POBJ#);

ALTER TABLE SYSTEM.REPCAT$_REPCOLUMN ADD CONSTRAINT REPCAT$_REPCOLUMN_PK PRIMARY KEY (SNAME, ONAME, TYPE, CNAME);

ALTER TABLE SYSTEM.LOGMNR_OBJ$ ADD CONSTRAINT SYS_C001044 PRIMARY KEY (LOGMNR_UID, OBJ#);
...
ALTER TABLE SYSTEM.MSUSEREJB ADD CONSTRAINT PK_MSUSEREJB PRIMARY KEY (MSUCODE);

ALTER TABLE SYSTEM.CONTRACTOR_TYPE ADD CONSTRAINT PK_CONTRACTOR_TYPE PRIMARY KEY (ID_CONTRACTOR_TYPE);
...
ALTER TABLE SYSTEM.APPLICATIONFILES ADD CONSTRAINT SYS_C002727 PRIMARY KEY (IDFILE);
...
ALTER TABLE SYSTEM.CONTRACTORS ADD CONSTRAINT PK_CONTRACTORS PRIMARY KEY (ID_CONTRACTOR);
...
ALTER TABLE SYSTEM.LOGMNR_ATTRIBUTE$ ADD CONSTRAINT SYS_C001056 PRIMARY KEY (LOGMNR_UID, TOID, VERSION#, ATTRIBUTE#);

ALTER TABLE SYSTEM.LOGMNR_TABPART$ ADD CONSTRAINT SYS_C001051 PRIMARY KEY (LOGMNR_UID, OBJ#, BO#);

ALTER TABLE SYSTEM.LOGMNR_LOB$ ADD CONSTRAINT SYS_C001057 PRIMARY KEY (LOGMNR_UID, OBJ#, INTCOL#);

ALTER TABLE SYSTEM.AQ$_QUEUE_TABLES ADD CONSTRAINT AQ$_QUEUE_TABLES_PRIMARY PRIMARY KEY (OBJNO);

ALTER TABLE SYSTEM.DOCUMENTS_TYPE ADD CONSTRAINT PK_DOCUMENT_TYPE PRIMARY KEY (ID_DOCUMENT_TYPE);

ALTER TABLE SYSTEM.FILE_REQUEST ADD CONSTRAINT PK_FILE_REQUEST PRIMARY KEY (ID_REQUEST);

ALTER TABLE SYSTEM.MVIEW$_ADV_WORKLOAD ADD CONSTRAINT MVIEW$_ADV_WORKLOAD_PK PRIMARY KEY (QUERYID#);

ALTER TABLE SYSTEM.DEF$_AQERROR ADD CONSTRAINT SYS_C001027 PRIMARY KEY (ENQ_TID, STEP_NO);

ALTER TABLE SYSTEM.WORKPOSITIONEJB ADD CONSTRAINT PK_WORKPOSITIONEJB PRIMARY KEY (WORKPOSITION);

ALTER TABLE SYSTEM.TARGET_TYPE ADD CONSTRAINT PK_TARGET_TYPE PRIMARY KEY (ID_TARGET_TYPE);

ALTER TABLE SYSTEM.DEF$_PROPAGATOR ADD CONSTRAINT DEF$_PROPAGATOR_PRIMARY PRIMARY KEY (USERID);

ALTER TABLE SYSTEM.PATTERN_DOCS ADD CONSTRAINT PK_PATTERN PRIMARY KEY (ID_PATTERN);

ALTER TABLE SYSTEM.STOP_FACTOR_FOR_CONTRACTOR ADD CONSTRAINT PK_STOP_FACTOR_FOR_CONTRACTOR PRIMARY KEY (ID_STOP_FACTOR, ID_CONTRACTOR);

ALTER TABLE SYSTEM.LOGMNR_SPILL$ ADD CONSTRAINT SYS_C001063 PRIMARY KEY (SESSION#, XIDUSN, XIDSLT, XIDSQN, CHUNK);
...
ALTER TABLE SYSTEM.OPERATOREJB ADD CONSTRAINT PK_OPERATOREJB PRIMARY KEY (OPERATOR);

ALTER TABLE SYSTEM.REPCAT$_REPPROP ADD CONSTRAINT REPCAT$_REPPROP_PRIMARY PRIMARY KEY (SNAME, ONAME, TYPE, DBLINK);

ALTER TABLE SYSTEM.LOGMNR_IND$ ADD CONSTRAINT SYS_C001049 PRIMARY KEY (LOGMNR_UID, OBJ#);

ALTER TABLE SYSTEM.COMMISSION_TYPE ADD CONSTRAINT PK_COMMISSION_TYPE PRIMARY KEY (ID_COMMISSION_TYPE);

ALTER TABLE SYSTEM.MVIEW$_ADV_ELIGIBLE ADD CONSTRAINT MVIEW$_ADV_ELIGIBLE_PK PRIMARY KEY (SUMOBJN#, RUNID#);

ALTER TABLE SYSTEM.LINK_OWNFORM_DOCTYPE ADD CONSTRAINT PK_LINK_OWNFORM_DOCTYPE PRIMARY KEY (ID_DOCUMENT_TYPE, ID_OWNERSHIP_FORM_TYPE);

ALTER TABLE SYSTEM.PATTERN_INTEREST_RATE ADD CONSTRAINT PK_PATTERN_INTEREST_RATE PRIMARY KEY (ID_PATTERN_INTEREST_RATE);

ALTER TABLE SYSTEM.LOGMNR_TS$ ADD CONSTRAINT SYS_C001048 PRIMARY KEY (LOGMNR_UID, TS#);
...
ALTER TABLE SYSTEM.LOGMNR_CDEF$ ADD CONSTRAINT SYS_C001058 PRIMARY KEY (LOGMNR_UID, CON#);
...
ALTER TABLE SYSTEM.OPPORTUNITY_TYPE ADD CONSTRAINT PK_OPPORTUNITY_TYPE PRIMARY KEY (ID_OPPORTUNITY_TYPE);

ALTER TABLE SYSTEM.PEOPLEEJB ADD CONSTRAINT PK_PEOPLEEJB PRIMARY KEY (MAN);
...
ALTER TABLE SYSTEM.WORKEREJB ADD CONSTRAINT PK_WORKEREJB PRIMARY KEY (WORKER);
...
ALTER TABLE SYSTEM.PATTERN_PAID_PERCENT_TYPE ADD CONSTRAINT PK_PATTERN_PAID_PERCENT_TYPE PRIMARY KEY (ID_PAID_PERCENT_TYPE);

ALTER TABLE SYSTEM.REPCAT$_KEY_COLUMNS ADD CONSTRAINT REPCAT$_KEY_COLUMNS_PRIMARY PRIMARY KEY (SNAME, ONAME, COL);

ALTER TABLE SYSTEM.AQ$_INTERNET_AGENTS ADD CONSTRAINT SYS_C001015 PRIMARY KEY (AGENT_NAME);

ALTER TABLE SYSTEM.AQ$_INTERNET_AGENTS ADD CONSTRAINT UNQ_CONN_USERNAME UNIQUE (AGENT_NAME);

ALTER TABLE SYSTEM.SPO_SETTINGS ADD CONSTRAINT PK_SPO_SETTINGS PRIMARY KEY (ID_DEPARTMENT);
...
ALTER TABLE SYSTEM.DIVISIONEJB ADD CONSTRAINT PK_DIVISIONEJB PRIMARY KEY (DIVISION);

ALTER TABLE SYSTEM.PROFILEEJB ADD CONSTRAINT PK_PROFILEEJB PRIMARY KEY (OPERATORID, KEY1, NAME);
...
CREATE TRIGGER SYSTEM.ON_BEFORE_INSERT_MESSAGE 
	BEFORE INSERT ON SYSTEM.MESSAGE
...
CREATE TRIGGER SYSTEM.ON_BEFORE_INSERT_MANAGER 
	BEFORE INSERT ON SYSTEM.MANAGERS
	REFERENCING NEW AS NEW OLD AS OLD
	FOR EACH ROW
BEGIN
  --if (:new.idMessage is null) then
...
CREATE TRIGGER SYSTEM.REPCATLOGTRIG 
	AFTER DELETE OR UPDATE ON SYSTEM.REPCAT$_REPCATLOG
	REFERENCING NEW AS NEW OLD AS OLD
	FOR EACH STATEMENT
BEGIN
...
CREATE TRIGGER SYSTEM.TGR_BI_RUSBANK 
	BEFORE INSERT ON SYSTEM.RUSBANK
	REFERENCING NEW AS NEW OLD AS OLD
	FOR EACH ROW
begin
...
CREATE TRIGGER SYSTEM.ON_BEFORE_INSERT_ORGANIZATION 
...
CREATE TRIGGER SYSTEM.ON_BI_META_SIMPLE_VOCABULARY 
	BEFORE INSERT ON SYSTEM.META_SIMPLEVOCABULARY
	REFERENCING NEW AS NEW OLD AS OLD
	FOR EACH ROW
BEGIN
...
CREATE TRIGGER SYSTEM.ON_BEFORE_INSERT_SHAREHOLDER 
	BEFORE INSERT ON SYSTEM.SHAREHOLDERS
	REFERENCING NEW AS NEW OLD AS OLD
	FOR EACH ROW
BEGIN
  --if (:new.idMessage is null) then
