 ...
 */
public abstract class DomainEJBMapper implements Mapper {
 ...
 */
public VtbObject findByPrimaryKey(VtbObject domainObjectWithKeyValues) throws MappingException {
 ...
 */
protected abstract EJBLocalObject findEJBObjectMatching(VtbObject domainObject) throws MappingException;
/**
 ...
 */
public abstract VtbObject map(EJBLocalObject input) throws MappingException;
/**
 ...
 * @param domainObject java.lang.Object
 */
public void remove(VtbObject domainObject) throws MappingException {
