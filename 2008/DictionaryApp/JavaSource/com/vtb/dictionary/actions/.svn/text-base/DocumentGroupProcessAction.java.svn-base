 ...
 * @author
 */
public class DocumentGroupProcessAction extends Action
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (DialogForm.ACTION_ADD.equalsIgnoreCase(action)) {
				processor.addDocumentGroup(documentGroupDialogForm.getVo());
				documentGroupDialogForm.setFlagOperation(true);
			} else if (DialogForm.ACTION_EDIT.equalsIgnoreCase(action)) {
				processor.updateDocumentGroup(documentGroupDialogForm.getVo());
				documentGroupDialogForm.setFlagOperation(true);
			} else if (DialogForm.ACTION_DELETE.equalsIgnoreCase(action)) {
				processor.removeDocumentGroup((int)documentGroupDialogForm.getVo().getId_document_group());
				documentGroupDialogForm.setFlagOperation(true);
			}
		} catch (Exception e) {
