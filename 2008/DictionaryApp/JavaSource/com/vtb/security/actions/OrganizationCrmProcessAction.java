 ...
 * @author
 */
public class OrganizationCrmProcessAction extends Action

{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			if (DialogForm.ACTION_EDIT.equalsIgnoreCase(action)) {
				processor.updateOrganizationCRM(dialogForm.getVo());
