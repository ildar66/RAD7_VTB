...
import com.vtb.security.forms.OrganizationToAddressDialogForm;

/**
 * @version 1.0
 * @author
 */
public class OrganizationToAddressProcessAction extends Action

{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		OrganizationToAddressDialogForm dialogForm = (OrganizationToAddressDialogForm) form;
