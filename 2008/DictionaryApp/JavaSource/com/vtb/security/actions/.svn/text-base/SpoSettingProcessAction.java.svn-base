 ...
 * @author
 */
public class SpoSettingProcessAction extends Action

{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			String action = spoSettingDialogForm.getAction();
			if (DialogForm.ACTION_ADD.equalsIgnoreCase(action)) {
				processor.addSpoSetting(spoSettingDialogForm.getVo());
				spoSettingDialogForm.setFlagOperation(true);
			} else if (DialogForm.ACTION_EDIT.equalsIgnoreCase(action)) {
				processor.updateSpoSetting(spoSettingDialogForm.getVo());
				spoSettingDialogForm.setFlagOperation(true);
			}
		} catch (Exception e) {
