...
import com.vtb.security.forms.OrganizationGroupListForm;
 ...
 * @author ildar
 */
public class OrganizationGroupListAction extends Action {

	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		ActionForward forward = null;
		try {
			// Look at the ActionForm object
			OrganizationGroupListForm aForm = (OrganizationGroupListForm) form;
			...
			request.setAttribute(BeanKeys.ORGANIZATION_GROUP_LIST, list); 
			forward = mapping.findForward("success");
		} catch (ModelException e) {
			AppService.log(TraceCapable.ERROR_LEVEL, "Exception caught in OrganizationGroupListAction.execute:" + e);
		}
		if (forward == null) {
