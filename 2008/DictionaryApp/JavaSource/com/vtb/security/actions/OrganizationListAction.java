...
import com.vtb.security.forms.OrganizationListForm;
 ...
 * @author
 */
public class OrganizationListAction extends Action {

	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		ActionForward forward = null;
		try {
			// Look at the ActionForm object
			OrganizationListForm aForm = (OrganizationListForm) form;
			...
			request.setAttribute(BeanKeys.ORGANIZATION_LIST, list); 
