 ...
 */
package com.vtb.security.console.events;

import java.util.List;

import com.vtb.security.console.core.event.EventStore;
import com.vtb.security.console.core.event.NriAdiminNotification;
...
public class EventManagerBean implements EventStore {
	...
	/* (non-Javadoc)
	 * @see com.vtb.security.console.core.event.EventStore#storeEvent(int, com.vtb.security.console.core.event.NriAdiminNotification)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vtb.security.console.core.event.EventStore#getAllEvents(int)
	 */
