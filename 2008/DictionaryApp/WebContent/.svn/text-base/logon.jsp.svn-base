...
<%
	if (request.getSession().getAttribute(com.vtb.security.console.core.Constants.USER_KEY) != null) {
		request.getSession().removeAttribute(com.vtb.security.console.core.Constants.USER_KEY);
		request.getSession().removeAttribute(com.vtb.security.console.core.Constants.CURRENTCELLCTXT_KEY);
		request.getSession().removeAttribute(com.vtb.security.console.core.Constants.CURRENTNODECTXT_KEY);
	}
%>
 ...
 <%--table border="0" cellpadding="0" cellspacing="0" width="100%" background="<%= request.getContextPath() + "/" %>images/background.jpg" >
  <tr >
    ...
    <td align="right" width="40%"><img src="<%= request.getContextPath() + "/" %>images/IBM-logo.jpg"
    	width="112" height="52" alt="<bean:message key="NRI.logo"/>"></td>
    </tr>
 </table--%>
