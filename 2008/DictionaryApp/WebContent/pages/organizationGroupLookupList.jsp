...
<HEAD>
	...
	<TITLE>Справочник Группы клиентов</TITLE>
</HEAD>
<BODY class="content">
...
<%
 	...
 	OrganizationGroupLookupListForm listForm = (OrganizationGroupLookupListForm)session.getAttribute("OrganizationGroupLookupListForm");
 	String sortBy = listForm.getOrderBy();
 	java.util.List posList = (java.util.List)request.getAttribute(BeanKeys.ORGANIZATION_GROUP_LOOKUP_LIST);
...
<H3 id='bread-crumb'>
	...
	Справочник Группы клиентов
</H3><br>
<html:form action="/organizationGroupLookupList.do" styleId="listForm">
<html:errors/>
...
<table class="framing-table" id="tableID" BORDER="0" CELLPADDING="3" CELLSPACING="1" width="100%">
    ...
    <tr class="title">
        ...
        <!-- Table body -->
    <logic:iterate id="item" name="<%=BeanKeys.ORGANIZATION_GROUP_LOOKUP_LIST%>" type="com.vtb.custom.OrganizationGroupTO">
