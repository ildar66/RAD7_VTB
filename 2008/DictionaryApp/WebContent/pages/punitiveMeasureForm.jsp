...
<BODY class="content">
<%
	String form = "PunitiveMeasureDialogForm";
	String src = request.getContextPath() + "/images/save.gif";
	String alt = "Сохранить запись";
%>

<H3 id='bread-crumb'><html:link page="/punitiveMeasureList.do" styleClass="navigator">Справочник Штрафных санкций</html:link> &gt;
	<bean:write name="<%= form%>"/> :
</H3><br>

<html:form action="/punitiveMeasureProcess.do" focus="vo.name">
<html:errors/>
...
<script language="javascript">
	...
	function storeID() {
		document.cookie = "PunitiveMeasureListForm=" + document.<%= form %>['vo.id'].value;
	}	
</script>
...
<table class="wizard-table" border="0" cellpadding="3" cellspacing="0">
    ...
    <tr>
    	<td class="column-head-name" colspan="2">
			...
			<html:link page="/punitiveMeasureList.do" styleClass="navigator">
		...
		<td colspan="2">
			<table>
			    <tr>
			        ...
			        <td class="text">
			          <html:text property="vo.id" size="25" readonly="true"/>
			        </td>
			    </tr>
			    ...
			    <tr>
			        ...
			        <td class="text">
			          <html:textarea property="vo.name" rows="4" />
			        </td>
			    </tr>
			</table>
		</td>
