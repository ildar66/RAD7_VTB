...
<%
   ...
   if (isSecurityEnabled) {
      ((HttpServletResponse)pageContext.getResponse()).sendRedirect(request.getContextPath() + "/logon.do?action=none_secure");//action=secure
   }
%>
...
<html:form action="logon.do" name="logonForm" focus="username" type="com.vtb.security.console.core.form.LogonForm">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" background="<%= request.getContextPath() + "/" %>images/background.jpg" >
  <tr >
    ...
    <td align="right" width="40%"><img src="<%= request.getContextPath() + "/" %>images/NRI-logo.jpg"
        ...
        <tbody>
          ...
          <tr > 
            ...
            <td valign=top class="table-text"> 
              ...
              <html:hidden property="action" value="none_secure"/>  
            </td>
          </tr>
          <tr> 
