...
<table class="noframe-framing-table" border="0" cellpadding="3" cellspacing="0" width="100%" >
    <tr valign="top">
        <td class="top-navigation">
            <logic:iterate id="item" name="menuBarItems" type="com.vtb.security.console.core.item.MenuBarItem" >
<% 
...
%>
        ...
        <td class="top-navigation" align=right>
			<form name="descriptionsForm" action="<%=request.getContextPath()%>/menuBarCmd.do?forwardName=toggleDescriptions" method="post">
			<% 
			...
			%>		
			            <input type="image" name="descriptionsON" src="<%=request.getContextPath()%>/images/descriptionsON.gif" alt="<%--bean:message key="hide.field.page.descriptions"/--%>" align="texttop" border="0" onclick="top.framesetMenu.cols='0%,*'">&nbsp;&nbsp;
			 <%
			 		} else {
			 %>		
			            <input type="image" name="descriptionsOFF" src="<%=request.getContextPath()%>/images/descriptionsOFF.gif" alt="<%--bean:message key="show.field.page.descriptions"/--%>" align="texttop" border="0" onclick="top.framesetMenu.cols='21%,*'">&nbsp;&nbsp;
			 <%
			 		}
