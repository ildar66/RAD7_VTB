...
<%@ page import="com.vtb.security.console.core.bean.StatusBean" %>
<%@ page import="java.util.*" %>
<%@ page import="com.vtb.security.console.core.bean.UserPreferenceBean" %>
...
<jsp:useBean id="statusBean" class="com.vtb.security.console.core.bean.StatusBean" scope="session"/>
...
<% String refresh = "60000";%>
<tiles:useAttribute name="statusPanels" classname="java.util." />
    ...
    <tr> 
      <td class="layout-manager" id="notabs"> 
        ...
        <table border="0" cellpadding="2" cellspacing="0" valign="top" width="100%" summary="Framing Table" >
          <tr> 
            <td class="was-message-item" nowrap><%--bean:message key="statustray.title" /--%>VTB Status
            	<ibmcommon:info image="help.additional.information.image" topic="statusTray"/>
            </td>
			<td class="was-message-item" nowrap><input type="submit" name="action" value='<%--bean:message key="statustray.prev.button"/--%>Previous' class="buttons" id="paging"><input type="submit" name="action" value='<%--bean:message key="statustray.next.button"/--%>Next' class="buttons" id="paging"> </td>
            ...
            <%@ page import = "java.util.*, java.text.*"%><%= DateFormat.getDateTimeInstance(DateFormat.LONG,DateFormat.LONG,request.getLocale()).format(new Date()) %> 
              ...
              <img src="<%=request.getContextPath()%>/images/refresh.gif"  alt="<%--bean:message key="refresh.data"/--%>Refresh Data" align="texttop" border="0"></a></td>
          </tr>
         </table>
           ...
           <% if (statusBean.getRendererUri() != null && !statusBean.getRendererUri().equals(""))  {%>
               ...
               <tr align="center"> 
                 <td nowrap>
                     ...
                     <jsp:include page="<%=statusBean.getRendererUri()%>" flush="true" />
                </td>
               </tr>
               </table>
        ...
        <table border="0" cellpadding="2" cellspacing="0" valign="top" width="100%" summary="Framing Table" >
          <tr valign="top"> 
            <td class="find-filter" valign="bottom" align="left" width="33%" nowrap > 
              ...
              <%--bean:message key="consolehome.preferences" /--%>Preferences
              ...
              <table border="0" cellpadding="2" cellspacing="1" width="100%" summary="Properties Table">
                <tr valign="top"> 
                  <td class="table-text"    nowrap valign="top"> 
                    <%--bean:message key="statusTray.preference.refresh" /--%>Automatic Refresh</td>
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="2">
                      <tr> 
                        <td nowrap class="table-text"> 
                          ...
                          <%--bean:message key="statusTray.preference.enable" /--%>Enable</td>
                      </tr>
                      <tr> 
                        <td nowrap class="complex-property"><%--bean:message key="statusTray.preference.interval" /--%>Refresh interval
                          <input type="text" name="name2" size="15" lang="en_US" value="<%=refreshRate%>">
                          <%--bean:message key="statusTray.preference.units" /--%>seconds</td>
                      </tr>
                      <tr> 
                        <td nowrap class="complex-property"> 
                          ...
                          <%--bean:message key="statusTray.preference.cycle" /--%>Automatically cycle content</td>
                      </tr>
                    </table>
                  </td>
                  <td class="table-text" valign="top" > <ibmcommon:info image="help.additional.information.image.align" topic="statusTray.preference.description"/>
					...
					Automatically refreshes the system tray with up to date information on the specified interval. You may also enable automatic cycling through the content in the system tray on the specified refresh interval.                     
                  </td>
                </tr>
                <tr> 
                  <th valign="top" class="button-section" colspan="3"> 
                    <input type="submit" name="submit2" value="<%--bean:message key="button.apply"/--%>Apply" class="buttons" id="navigation">
                    <input type="reset" name="reset" value="<%--bean:message key="button.reset"/--%>Reset" class="buttons" id="navigation">
                  </th>
                </tr>
              </table>
            </td>
