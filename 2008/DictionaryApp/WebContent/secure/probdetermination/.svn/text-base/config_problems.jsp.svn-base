...
<table border="0" cellpadding="2" cellspacing="1" summary="List table"
	...
	<tr>
		<td class="column-head" colspan="4" nowrap>
			<%--bean:message key="configproblems.status.title" /--%>
			VTB Configuration Problems
		</td>
	</tr>

	<tr>
		<td class="table-text" width="293">
			<%--bean:message key="configproblems.status.totalcfgLabel" /--%>Total Configuration Problems :<%=msg%></td>
		<td class="table-text" width="209">
			<img alt='<%--bean:message key="error.msg.error"/--%>Error'
			...
			target="WAS_Status"><%=errorConfigCount%> <%--bean:message	key="events.total" /--%>total </a></td>
		<td class="table-text">
			<img alt='<%--bean:message key="error.msg.warning"/--%>Warning'
			src="<%=request.getContextPath()%>/images/Warning.gif"
			width="16" height="16" align="texttop">: <a
			...
			target="WAS_Status"><%=warningConfigCount%> <%--bean:message key="events.total" /--%>total </a></td>
		<td class="table-text">
			<img alt='<%--bean:message key="error.msg.information"/--%>Information'
			src="<%=request.getContextPath()%>/images/Information.gif"
			width="16" height="16" align="texttop">: <a
			...
			target="WAS_Status"><%=infoConfigCount%> <%--bean:message key="events.total" /--%>total </a></td>
	</tr>
</table>