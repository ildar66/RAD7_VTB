...
public class _TimerEJB_Stub extends Stub implements TimerEJB {
    
    private static final String[] _type_ids = {
        "RMI:com.timer.ejb.TimerEJB:0000000000000000", 
    ...
    public void initializeTimer(Date arg0, long arg1, String arg2) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("initializeTimer",com.timer.ejb.TimerEJB.class);
                if (so == null) {
                    continue;
                }
                try {
                    ...
                    ((com.timer.ejb.TimerEJB)so.servant).initializeTimer(arg0Copy, arg1, arg2Copy);
                    return;
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
    ...
    public void cancelTimer(String arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("cancelTimer",com.timer.ejb.TimerEJB.class);
                if (so == null) {
                    continue;
                }
                try {
                    ((com.timer.ejb.TimerEJB)so.servant).cancelTimer(arg0);
                    return;
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
    ...
    public void getTimerInfo() throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        OutputStream out = _request("getTimerInfo", true);
                        _invoke(out);
                        return;
                    } catch (ApplicationException ex) {
                        in = ex.getInputStream();
                ...
                ServantObject so = _servant_preinvoke("getTimerInfo",com.timer.ejb.TimerEJB.class);
                if (so == null) {
                    continue;
                }
                try {
                    ((com.timer.ejb.TimerEJB)so.servant).getTimerInfo();
                    return;
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
