...
public abstract class JDBCMapper implements Mapper {
	...
	public static DataSource getDataSource() {
		...
		try {
			...
			ds = (DataSource) context.lookup(REFERENCE_NAME_PREFIX + ApplProperties.getDatasourceJndiName());
	...
	public void insert(VtbObject anObject) throws DuplicateKeyException, MappingException {
		...
		try {
			...
			AppService.log(TraceCapable.ERROR_LEVEL,"Exception " + se + " caught in insert()");			
